...
interface Event {
  ...
  city: string;
  time: string;
  image: any; // Pour l'importation d'images locales
}
...
// Composant pour grouper les événements par région
interface RegionSectionProps {
  region: string;
  events: Event[];
}

const RegionSection: React.FC<RegionSectionProps> = ({ region, events }) => {
  return (
